	...
	<script>
		$(document).ready(function(){
			...
			function updatePw(){
				...
				else if ($('#pw').val() == ''){	// 나중엔 여기를 비밀번호 정규식으로 변경					
					alert('새 비밀번호를 확인하세요.');
					return;
				}
...
<body>
	<form id="my_form">
		...
		<a href="/12_AJAX/logout.do">로그아웃하기</a>
		...
		<input type="button" value="정보수정하기" id="update_member_btn">
